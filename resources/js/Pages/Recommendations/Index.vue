    ...
    <RecommendationLayout :tab="tab" :place="place">
        <TabsContent :value="tab">
            <div class="grid sm:grid-cols-3 grid-cols-1 gap-4">
                <h2 class="sm:block hidden col-span-3 text-2xl font-semibold text-black dark:text-white">Durchschnitt die nächsten
                    Tage</h2>
                ...
                <h2 class="sm:block hidden col-span-3 text-2xl font-semibold text-black dark:text-white">Vorhersage</h2>
